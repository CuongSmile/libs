 ...
 * {@link com.panasonic.avc.media.wifirw.ui.view.widget.stickygrid.tonicartos.widget.stickygridheaders.StickyGridHeadersBaseAdapter}.
 * 
 * @author Tonic Artos
 */
public interface StickyGridHeadersSimpleAdapter extends ListAdapter {
     ...
     */
    int getHeaderCountAtPosition(int pos);
}
