...
//        this.mHeaders = new HeaderData[0];
    ...
    protected HeaderData[] generateHeaderList(StickyGridHeadersSimpleAdapter adapter) {
        ...
        HeaderData[] ret = headers.toArray(new HeaderData[headers.size()]);
        return ret;
    }
	...
	@Override
	public int getHeaderCountAtPosition(int pos) {
		return mDelegate.getHeaderCountAtPosition(pos);
	}
